...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<Map<String, dynamic>> uploadImage(File image,
    ...
    final imageUploadRequest = http.MultipartRequest(
      'POST',
      Uri.parse(
          'https://us-central1-flutter-products-630c0.cloudfunctions.net/storeImage'),
    );
  ...
  Future<bool> addProduct(String title, String description, File image,
    ...
    try {
      final http.Response response = await http.post(
          'https://flutter-products-630c0.firebaseio.com/products.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> updateProduct(String title, String description, File image,
    ...
    try {
      final http.Response response = await http.put(
          'https://flutter-products-630c0.firebaseio.com/products/${selectedProduct.id}.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://flutter-products-630c0.firebaseio.com/products/$deletedProductId.json?auth=${_authenticatedUser.token}')
  ...
  void toggleProductFavoriteStatus(Product toggledProduct) async {
    ...
    if (newFavoriteStatus) {
      response = await http.put(
          'https://flutter-products-630c0.firebaseio.com/products/${toggledProduct.id}/wishlistUsers/${_authenticatedUser.id}.json?auth=${_authenticatedUser.token}',
  ...
  Future<Map<String, dynamic>> authenticate(String email, String password,
    ...
    if (mode == AuthMode.Login) {
      response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyCZ_vxEE0uAbkixZYPFA-_aSx9eNPqOUTg',
        body: json.encode(authData),
        headers: {'Content-Type': 'application/json'},
      );
    } else {
      response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyCZ_vxEE0uAbkixZYPFA-_aSx9eNPqOUTg',
        body: json.encode(authData),
        headers: {'Content-Type': 'application/json'},
      );
    }
